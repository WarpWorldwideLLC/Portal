...
<html>
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1">
  		<link rel="stylesheet" type="text/css" href="/cssx/store.css">
  		<link rel="icon" type="image/png" sizes="104x80" href="/images/logo.png">
		<script>
			var stripe = Stripe('pk_test_SVBFNF3t7mU3ycUFW8nEzENp');
        ...
        <section>
          ...
          <div class="payment-info sepa_debit">
            <fieldset>
              <label>
                <span>IBAN</span>
                <input name="iban" class="field" placeholder="FR14 2004 1010 0505 0001 3M02 606" />
              </label>
            </fieldset>
