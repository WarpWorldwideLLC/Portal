...
<body>
    <form method="post" action="botdetect" class="column" id="form1">
        ...
        <div class="column">
            <% if (Captcha.isFree()) { %>
                <div class="note warning">
                    ...
                    <p>These limitations are removed if you <a rel="nofollow" href="http://captcha.com/shop.html?utm_source=installation&amp;utm_medium=java&amp;utm_campaign=4.0.Beta3.1" title="BotDetect CAPTCHA online store, pricing information, payment options, licensing &amp; upgrading">upgrade</a> your BotDetect license.</p>
                </div>
            <% } %>
