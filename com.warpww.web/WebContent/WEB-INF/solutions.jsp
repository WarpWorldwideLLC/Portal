...
<body>
		...
		<form>
			...
			<div id="solution_panel" class="row" style="width: 99%; vertical-align: text-top; display: flex;">
		        ...
		        <div id="warp_sirius" class="block" style="width: 33%; vertical-align: text-top;  background-color: skyblue; border-radius: 25px; padding: 20px; ">
		        		<div >
		        			...
		        			<div style="margin-left: 25px;">
		        				...
		        				<div style="margin-left: 25px;">
		        					...
		        					<fmt:message key="warp_sirius.p3.7" /><br>
		        				</div>
		        				<fmt:message key="warp_sirius.p3.8" /><br>
		        				<fmt:message key="warp_sirius.p3.9" /><br>
		        				<fmt:message key="warp_sirius.p3.10" /><br>
		        				<fmt:message key="warp_sirius.p3.11" /><br>
		        			</div>
